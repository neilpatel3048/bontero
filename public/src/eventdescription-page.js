class EventDescPage extends HTMLElement
{
    constructor()
    {
        super();
...
<br> 
   ...
   <li><span> <ion-icon class="eventDesc" name="pin"></ion-icon> Meet at Barceloneta metro station</span></li>
    ...
    <div class="details">
        <h4>Details</h4>
        <br>
        <p class="eventcopy">Join us as we get together on our monthly clean up of San Sebastia beach. We want to keep our beach beautiful and special for locals and visitors to this beautiful part of town! Come for a few hours to clean, meet new friends, and enjoy some refreshments afterwards. </p>
        <br>
        <p class="eventcopy">Note: Where comfortable clothes and sandals</p>
        <br>
        <p class="eventcopy">See you there! </p>
    </div>
    <br>
    <hr style="height:1px; border:none; color:#000; background-color:#000; width:80%; text-align:center; margin: 0 auto;">
    <br>
...
customElements.define('eventdescription-page', EventDescPage)