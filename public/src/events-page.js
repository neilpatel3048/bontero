class EventsPage extends HTMLElement {
    ...
    connectedCallback(){
        console.log(`Heyyy I'm Events Page!!!`);
   ...
   <div class="container1">
     ...
     <!-- These are all the cards within the page-->
        <ion-card>
          <ion-img src="https://firebasestorage.googleapis.com/v0/b/bontero-50f6a.appspot.com/o/BeachCleaning.png?alt=media&token=fe00fc26-a03e-4e1f-9401-379bc0d707af"></ion-img>
          <ion-card-header>
      ...
      <ion-card>
          <ion-card-header>
            <ion-img src="https://firebasestorage.googleapis.com/v0/b/bontero-50f6a.appspot.com/o/Ciutadella200th.png?alt=media&token=de9d4436-25e7-4579-8e81-414dcc9df626"></ion-img>
       ...
       <ion-card>
          <ion-card-header>
            <ion-img src="https://firebasestorage.googleapis.com/v0/b/bontero-50f6a.appspot.com/o/event_planting.png?alt=media&token=94dd8155-b97c-47d3-921c-d94857f9d09a"></ion-img>
          ...
          <ion-card>
          <ion-card-header>
            <ion-img src="https://firebasestorage.googleapis.com/v0/b/bontero-50f6a.appspot.com/o/TutorKidsReuseRecycle.png?alt=media&token=eaeb5573-8938-40cf-b5cc-fb902c9f48fc"></ion-img>
